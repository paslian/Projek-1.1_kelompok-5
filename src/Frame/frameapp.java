...
public class frameapp extends javax.swing.JFrame {
    ...
    private String validateForm1() {
            ...
            String tf1 = tf_tb.getText();
                        ...
                        if(tf1.length() < 1) {
                            flag.add("Silahkan isi tinggi badan anda!");
                        }

                        if(!tf1.matches("[0-9]+")){
                            flag.add("mohon masukkan angka!");
                        }

            JComboBox<String> tf2 = cb_gender;

                                    if(tf2.getSelectedIndex()==0) {
                                        flag.add("Silahkan masukkan Jenis Kelamin!");
                                    }
    ...
    private void initComponents() {
        ...
        cb_gender.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Jenis Kelamin", "Boy", "Girl" }));
